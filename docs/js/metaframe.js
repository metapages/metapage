...
var metapage_client_library_Metaframe = $hx_exports["Metaframe"] = function(opt) {
	this._debug = false;
	this._color = "";
	...
	this._isIframe = metapage_client_library_Metaframe.isIframe();
	var $window = window;
	if(opt != null && opt.showBanner && !this._isIframe) {
		metapage_client_library_Metaframe.showBanner();
	}
	if(!this._isIframe) {
		this.ready = new Promise(function(resolve,reject) {
		});
		this.log("Not an iframe, metaframe code disabled",null,null,{ fileName : "Metaframe.hx", lineNumber : 43, className : "metapage.client.library.Metaframe", methodName : "new"});
		return;
	}
	...
	this.ready = new Promise(function(resolve1,reject1) {
		_gthis.once("SetupIframeServerResponse",function(params) {
			_gthis.debug("SetupIframeServerResponse params=" + Std.string(params),{ fileName : "Metaframe.hx", lineNumber : 52, className : "metapage.client.library.Metaframe", methodName : "new"});
			if(_gthis._iframeId == null) {
				...
				_gthis.debug("Got JsonRpcMethods.SetupIframeServerResponse but already resolved",{ fileName : "Metaframe.hx", lineNumber : 72, className : "metapage.client.library.Metaframe", methodName : "new"});
			}
		});
		_gthis.sendRpc("SetupIframeClientRequest",{ });
	});
};
metapage_client_library_Metaframe.__name__ = true;
metapage_client_library_Metaframe.isIframe = function() {
	try {
...
metapage_client_library_Metaframe.generateId = function(length) {
	if(length == null) {
		length = 8;
	}
	var s_b = "";
	while(length > 0) {
		s_b += Std.string(metapage_client_library_Metaframe.LETTERS.charAt(Math.max(0,Math.random() * metapage_client_library_Metaframe.LETTERS.length - 1) | 0));
		--length;
	}
	return s_b;
};
metapage_client_library_Metaframe.showBanner = function() {
	...
	style.innerHTML = metapage_client_library_Metaframe.BANNER_STYLE_TEXT;
	document.body.insertBefore(style,document.body.firstChild);
};
metapage_client_library_Metaframe.__super__ = metapage_client_library_EventEmitter;
metapage_client_library_Metaframe.prototype = $extend(metapage_client_library_EventEmitter.prototype,{
	...
	,addEventListener: function(event,listener) {
		var _gthis = this;
		var disposer = metapage_client_library_EventEmitter.prototype.addEventListener.call(this,event,listener);
		if(event == "input") {
	...
	,setInput: function(inputBlob) {
		...
		if(!_tmp1) {
			throw new js__$Boot_HaxeError(new metapage_client_library_AssertionFailure("pipeId != null",[{ expr : "pipeId", value : _tmp0},{ expr : "pipeId != null", value : _tmp1}]));
		}
	...
	,setOutput: function(updateBlob) {
		...
		var _tmp1 = _tmp0 != null;
		if(!_tmp1) {
			throw new js__$Boot_HaxeError(new metapage_client_library_AssertionFailure("updateBlob != null",[{ expr : "updateBlob", value : _tmp0},{ expr : "updateBlob != null", value : _tmp1}]));
		}
		var _tmp01 = updateBlob;
		var _tmp11 = _tmp01.name;
		var _tmp2 = _tmp11 != null;
		if(!_tmp2) {
			throw new js__$Boot_HaxeError(new metapage_client_library_AssertionFailure("updateBlob.name != null",[{ expr : "updateBlob", value : _tmp01},{ expr : "updateBlob.name", value : _tmp11},{ expr : "updateBlob.name != null", value : _tmp2}]));
		}
	...
	,sendRpc: function(method,params) {
		if(this._isIframe) {
			...
			this.debug("Sending message=" + HxOverrides.substr(JSON.stringify(message),0,200),{ fileName : "Metaframe.hx", lineNumber : 258, className : "metapage.client.library.Metaframe", methodName : "sendRpc"});
			window.parent.postMessage(message,"*");
		} else {
			this.error("Cannot send JSON-RPC window message: there is no window.parent which means we are not an iframe",{ fileName : "Metaframe.hx", lineNumber : 261, className : "metapage.client.library.Metaframe", methodName : "sendRpc"});
		}
	}
		...
		if(typeof e.data === "object") {
			...
			if(jsonrpc.jsonrpc == "2.0") {
				...
				if(!(method == "SetupIframeServerResponse" || jsonrpc.parentId == this._parentId && jsonrpc.iframeId == this._iframeId)) {
					this.error("Received message but jsonrpc.parentId=" + jsonrpc.parentId + " _parentId=" + this._parentId + " jsonrpc.iframeId=" + jsonrpc.iframeId + " _iframeId=" + this._iframeId,{ fileName : "Metaframe.hx", lineNumber : 274, className : "metapage.client.library.Metaframe", methodName : "onWindowMessage"});
					return;
				}
				switch(method) {
				case "InputUpdate":
				...
				this.log("!Bad JsonRPC version=" + jsonrpc.jsonrpc,null,null,{ fileName : "Metaframe.hx", lineNumber : 288, className : "metapage.client.library.Metaframe", methodName : "onWindowMessage"});
			}
		} else {
			this.log("!message is not an object",null,null,{ fileName : "Metaframe.hx", lineNumber : 291, className : "metapage.client.library.Metaframe", methodName : "onWindowMessage"});
		}
	}
	,internalOnInput: function(input) {
		this.debug("InputUpdate from registed RPC pipeId=" + input.name + " value=" + HxOverrides.substr(JSON.stringify(input.value),0,200),{ fileName : "Metaframe.hx", lineNumber : 297, className : "metapage.client.library.Metaframe", methodName : "internalOnInput"});
		var pipeId = input != null ? input.name : null;
		var pipeValue = input != null ? input.value : null;
		if(pipeId == null) {
			this.error("Missing \"name\" value in the params object to identify the pipe. input=" + Std.string(input),{ fileName : "Metaframe.hx", lineNumber : 301, className : "metapage.client.library.Metaframe", methodName : "internalOnInput"});
		} else {
			this.debug("Setting input value from InputPipeUpdate pipeId=" + pipeId,{ fileName : "Metaframe.hx", lineNumber : 303, className : "metapage.client.library.Metaframe", methodName : "internalOnInput"});
			this.setInput(input);
		}
	}
	,internalOnInputs: function(inputs) {
		this.debug("InputUpdates from registed RPC inputs=" + HxOverrides.substr(JSON.stringify(inputs),0,200),{ fileName : "Metaframe.hx", lineNumber : 310, className : "metapage.client.library.Metaframe", methodName : "internalOnInputs"});
	}
