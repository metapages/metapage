...
const ExampleMetapage = {
  ...
  metaframes: {
    ...
    "visualize and interact": {
      url:
        "https://metapage.io/mf/yrgfo0ncjb#?filesystem=false&frame=visualize%2Band%2Binteract&hideBorders=false&hideLabels=false&hideOptions=false&mermaid=false&minimal=false&showOptions=true",
      inputs: [
        {
          source: "plot.json",
          target: "plotly.json",
