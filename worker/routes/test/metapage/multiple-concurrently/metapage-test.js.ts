...
// Serves the browser-side test driver for the multiple-concurrently test at
// /test/metapage/multiple-concurrently/metapage-test.js. The script lives in static/ (and is
...
const FILE_PATH = "static/metapage-test-multiple-concurrently.js";
