...
// Serves the browser-side test driver for the io-pipe-names test at
// /test/metapage/io-pipe-names/metapage-test.js. The script lives in static/ (and is
...
const FILE_PATH = "static/metapage-test-io-pipe-names.js";
