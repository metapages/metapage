  ...
  return (
    <>
      <Head>
        ...
        <script src="https://unpkg.com/compare-versions/lib/umd/index.js">
        </script>
      </Head>
      <main>
        <p>Metapage test {testname} @ version: {displayVersion}</p>
        <a href="https://app.metapage.io/dion/metapage-npm-library-debug-early-messages-missed-e59b3aa35806425d80cff197f3e19da0?view=default">
          Source metapage
        </a>
        ...
        <script
          type="module"
          src={`/test/metapage/${testname}/metapage-test.js`}
        >
        </script>
      </main>
    </>
