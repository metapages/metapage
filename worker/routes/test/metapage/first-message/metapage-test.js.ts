...
// Serves the browser-side test driver for the first-message test at
// /test/metapage/first-message/metapage-test.js. The script lives in static/ (and is
...
const FILE_PATH = "static/metapage-test-first-message.js";
