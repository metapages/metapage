...
// Serves the browser-side test driver for the compatibility test at
// /test/metapage/compatibility/metapage-test.js. The script lives in static/ (and is
...
const FILE_PATH = "static/metapage-test-compatibility.js";
