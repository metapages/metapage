...
export default function MetaframePage(props: PageProps) {
  ...
  return (
    <>
      <Head>
        <meta charset="UTF-8" />
        <title>Metapage tests for v{displayVersion}</title>
        {/* <script type="module" src={metapageScriptSrc}></script> */}
      </Head>
    <main>
      <h1>Metapage tests for v{displayVersion}</h1>
      <br/>
      <ul>
        <li><a href={`./${version}/compatibility`}>Test all (non-deprecated) metaframe versions with this metapage version</a></li>
        <li><a href={`./${version}/timing`}>Test timing and internal APIs</a></li>
      </ul>
    </main>
    </>
  );
