...
export const MetaframeVersionsAll = ["0.3", "0.4", "0.5", "0.6"] as const;
// Create the type from the array
export type VersionsMetaframe = (typeof MetaframeVersionsAll)[number];

export const MetapageVersionsAll  = ["0.2", "0.3"] as const;
// Create the type from the array
export type VersionsMetapage = (typeof MetapageVersionsAll)[number];

export const MetaframeVersionCurrent :VersionsMetaframe = "0.6";
export const MetapageVersionCurrent :VersionsMetapage = "0.3";
